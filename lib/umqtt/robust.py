...
class MQTTClient(simple.MQTTClient):
    ...
    def __init__(self, *args, **kwargs):
        """
        See documentation for `umqtt.simple.MQTTClient.__init__()`
        """
    ...
    def is_keepalive(self):
        ...
        if 0 < self.keepalive < time_from__last_cpackage:
            self.conn_issue = (simple.MQTTException(7), 9)
            return False
        return True

    def set_callback_status(self, f):
        """
        See documentation for `umqtt.simple.MQTTClient.set_callback_status()`
        """
        self._cbstat = f
    ...
    def connect(self, clean_session=True):
        """
        See documentation for `umqtt.simple.MQTTClient.connect()`.
        ...
        try:
            ...
            return out
        except (OSError, simple.MQTTException) as e:
            self.conn_issue = (e, 1)
    ...
    def disconnect(self):
        """
        See documentation for `umqtt.simple.MQTTClient.disconnect()`
    ...
    def ping(self):
        """
        See documentation for `umqtt.simple.MQTTClient.ping()`
    ...
    def publish(self, topic, msg, retain=False, qos=0):
        """
        See documentation for `umqtt.simple.MQTTClient.publish()`
    ...
    def subscribe(self, topic, qos=0, resubscribe=True):
        """
        See documentation for `umqtt.simple.MQTTClient.subscribe()`
    ...
    def wait_msg(self):
        """
        See documentation for `umqtt.simple.MQTTClient.wait_msg()`
    ...
    def check_msg(self):
        """
        See documentation for `umqtt.simple.MQTTClient.check_msg()`
